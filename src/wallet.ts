...
import { InboundAddressesItem } from '@xchainjs/xchain-midgard/lib/generated/midgardApi'
...
import { calcNetworkFee, getContractAddressFromAsset } from './utils/swap.js'
...
export class Wallet {
  ...
  constructor(network: Network, phrase: string) {
    ...
    this.clients = {
      ...
      BTC: new BtcClient(settings) as any,
